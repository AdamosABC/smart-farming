...
import net.mcreator.smartfarming.block.Salatfaze3Block;
...
public class Rust2Procedure extends SmartFarmingModElements.ModElement {
	public Rust2Procedure(SmartFarmingModElements instance) {
		super(instance, 29);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				SmartFarmingMod.LOGGER.warn("Failed to load dependency x for procedure Rust2!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				SmartFarmingMod.LOGGER.warn("Failed to load dependency y for procedure Rust2!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				SmartFarmingMod.LOGGER.warn("Failed to load dependency z for procedure Rust2!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				SmartFarmingMod.LOGGER.warn("Failed to load dependency world for procedure Rust2!");
			return;
		}
				...
				if ((((world.getWorldInfo().getDayTime()) % 24000) == 1)) {
					if ((((randomChance) >= 0.5) || ((new Object() {
					...
					}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "modidAttemptsMade")) == 7))) {
						{
							...
							BlockState _bs = Salatfaze3Block.block.getDefaultState();
