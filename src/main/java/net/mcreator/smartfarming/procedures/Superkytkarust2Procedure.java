...
import net.mcreator.smartfarming.block.Superkytka3Block;
...
public class Superkytkarust2Procedure extends SmartFarmingModElements.ModElement {
	public Superkytkarust2Procedure(SmartFarmingModElements instance) {
		super(instance, 39);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				SmartFarmingMod.LOGGER.warn("Failed to load dependency x for procedure Superkytkarust2!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				SmartFarmingMod.LOGGER.warn("Failed to load dependency y for procedure Superkytkarust2!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				SmartFarmingMod.LOGGER.warn("Failed to load dependency z for procedure Superkytkarust2!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				SmartFarmingMod.LOGGER.warn("Failed to load dependency world for procedure Superkytkarust2!");
			return;
		}
				...
				if ((((world.getWorldInfo().getDayTime()) % 24000) == 1)) {
					if ((((randomChance) >= 0.5) || ((new Object() {
					...
					}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "modidAttemptsMade")) == 7))) {
						{
							...
							BlockState _bs = Superkytka3Block.block.getDefaultState();
