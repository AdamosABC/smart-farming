...
public class Salatfaze1Block extends SmartFarmingModElements.ModElement {
	@ObjectHolder("smart_farming:salatfaze_1")
	public static final Block block = null;
	public Salatfaze1Block(SmartFarmingModElements instance) {
		super(instance, 22);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(0, 0.001, 0, 16, 16, 16)).withOffset(offset.x, offset.y, offset.z);
		}
